...
//if (!($_SESSION['autenticado']) && isset($_SESSION['uid']) && isset($_SESSION['tc'])  && ($_SESSION['xy'])!=0  ) 
...
$sqlc = mysqli_query($con,"SELECT c.* from apps_clientes c
							where c.dependiente = '".$_SESSION['xy']."' 
...
<head>
  ...
  <link rel="stylesheet" type="text/css" defer href="../assets/sweetalert/dist/sweetalert.css">
</head>
...
<br>
        ...
        <div class="col-12 mt-4">
          <div class="card mb-4">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-1">Mis Empleados</h6>
              <div id="load_promo" style="display:none;">
				<img src="../assets/img/loading.gif">
			  </div>
			  <div class="col-12 text-end">
                  <button onclick="new_p(<?php echo $idu;?>,<?php echo $token;?>)" class="btn bg-gradient-dark btn-sm mb-0">Nuevo Empleado</button>
                </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
				  ...
				  <?php
						...
						$sql2 =mysqli_query($con,"SELECT  z.zzz from apps_zzz z
													where z.idc = '".$r2['id']."' ");
							$saldo = 0;
							if(mysqli_num_rows($sql2)!=0){
								$r3 = mysqli_fetch_assoc($sql2);
								$saldo = $r3['zzz'];
							}
				  ?>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $r2['nombres'];?></h6>
                           
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $r2['telefono'];?></p>
                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo $saldo;?> USD</span>
                      </td>
                      <td class="align-middle text-center">
							<?php echo $estado;?>
                      </td>
					  <td>
						<a onclick = "reloader(<?php echo $r2['id'];?>);" alt ="Recargar"><div class="col-8 text-end">
						  <div class="icon icon-shape bg-gradient-dark shadow text-center border-radius-md">
							<i class="ni ni-paper-diploma text-lg opacity-10" aria-hidden="true"></i>
						 </div>
						</div></a>
 ...
 <!--P2P-->
<div class="modal" id="form_reload_modal_add" tabindex="-1" role="dialog" aria-labelledby="form_reload_modal_add" aria-hidden="true">
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      <div class="modal-header">
	     <button type="button" class="close" onclick="cerrar_tax5();" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
		...
		<div id="load_r" style="display:none;">
				...
				<form id="form_rel_cambio" name ="form_rel_cambio" method="post"  class="form-horizontal">
					<fieldset>
						<legend>Datos de la Recarga</legend>
						<div class="form-group" id="titular">
							<label class="col-sm-3 control-label">Numero Tarjeta</label>
							<div class="col-sm-5">
							<label style="display:none;" id="sping"></label>
								<input type="text" readonly value = "" class="form-control" name="tarjeta" id="tarjeta" data-toggle="tooltip" data-placement="bottom" title="Tarjeta"> 
							</div>
						</div>
					...
					<div class="form-group">
						...
						<button type="button" id="btn_save" class="btn btn-lg btn-dark btn-label-right" onclick="save_pago_reloader();">Guardar Recarga</button>
						</div>
					</div>
				</form>
			</div>
...
<!--FIN P2P-->
<!--NEW EMPL-->
<div class="modal" id="form_emp_modal_add" tabindex="-1" role="dialog" aria-labelledby="form_emp_modal_add" aria-hidden="true">
  <div class="modal-dialog modal-xs">
    <div class="modal-content">
      <div class="modal-header">
	     <button type="button" class="close" onclick="cerrar_tax6();" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="form_cambio_modal"><i class="fa fa-globe"></i> Nuevo Empleado</h4>
      </div>
      <div class="modal-body">
		<div class="box-content no-padding">
		<div id="load_r2" style="display:none;">
				<img src="../assets/img/loading.gif">
	   </div>
				<div style="display:none;" id="div_msg2">
				</div>
				<form id="form_emp_cambio" name ="form_emp_cambio" method="post"  class="form-horizontal">
					<fieldset>
				...
				<div id="nacimiento" class="form-group">
					...
					<div class="col-sm-12">
						<input type="date" id="datepicker" max="<?php echo $fpermi;?>" name="fecha_nacimiento" class="input-group date form-control"  data-date-format="dd-mm-yyyy" placeholder="00-00-0000" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label style="color:#000000;" class="col-sm-12 control-label">Tipo Producto</label>
					<div class="col-sm-12">
						<select name="tcliente" id="tcliente" class="form-control">
                           <option value="111">Empleado</option>
						   <option value="114">Gift Card</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
					    <button type="button" id="btnFetch" onclick="add_cliente2();" class="spinner-button btn bg-gradient-warning w-100 mt-4 mb-0">Registrame</button>
					</div>
				</div>
				</form>
			</div>
...
<!--FIN EMPL-->
  ...
  <script type="text/javascript" language="javascript" defer src="../assets/sweetalert/dist/sweetalert.min.js"></script>
