				...
				<table class="table table-bordered table-striped table-hover table-heading table-datatable" id="datatable-1">
					...
					<? 
						...
						while($resultados = $obj->obtener_fila($mmarca,0)){
							...
							$resultados3 = $obj->obtener_fila($fatu,0);
						...
						<tr>
							...
							<a class="ajax-link" style="cursor:pointer" onclick="vent.carga_tiendas_ventas_det(<?=$resultados['id_mp']?>);"  data-toggle="tooltip" data-placement="bottom" title="Ver Detalles" >
							<?=$resultados['marca']?>
							</a>
							<?}else{
							...
							<td><?=number_format($resultados3['facturado'],2 ,",", ".")?> <?=$resultados['moneda']?></td>
							<td><button type="button" class="btn btn-default btn-danger" onclick="vent.borrar_todas(<?=$resultados['id_mp']?>,'<?=$resultados['marca']?>');">Borrar Ventas <i class="fa fa-trash-o"></i></span></button></td>
						</tr>
							<?}
							}?>
