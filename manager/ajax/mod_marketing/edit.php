		...
		<div class="content">
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="estado" class="form-control">
                            ...
                            <option value="1" <?php if ($row ['estado']==1){echo "selected";} ?>>Empresa</option>
							<option value="2" <?php if ($row ['estado']==2){echo "selected";} ?>>Particular</option>
							<option value="3" <?php if ($row ['estado']==3){echo "selected";} ?>>VIP</option>
						</select> 
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="submit" name="save" class="btn btn-lg btn-success" value="Guardar datos">
